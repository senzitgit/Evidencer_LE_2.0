 ...
 var logUserRole = "Writer";
 var DefaultLogUserRole = "Writer";
 ...
 $(document).ready(function() {
	...
	*/
     ...
     div.innerHTML = '<div class="list-group-item text-ellipsis"><b>' + ew + '</b> : <span class="badge bg-success" Style="font-size:10px;float:none;background-color:#a00a0a;">Writer : ' + defUser + '</span> : <b>Recording Started</b> </div> ';
